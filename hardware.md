---
title: eSpa Hardware - ESP32 Spa Pool Controller Options
description: eSpa hardware options for connecting your spa pool to WiFi. Build your own ESP32-based controller or buy a pre-assembled eSpa PCB ready to install.
head:
  - - meta
    - property: og:title
      content: eSpa Hardware - ESP32 Spa Pool Controller Options
  - - meta
    - property: og:description
      content: eSpa hardware options for connecting your spa pool to WiFi. Build your own ESP32-based controller or buy a pre-assembled eSpa PCB ready to install.
---
