---
title: eSpa on GitHub - Source Code Repositories
description: All eSpa project source code is open source on GitHub. Find firmware, hardware designs, and website source across our repositories.
head:
  - - meta
    - property: og:title
      content: eSpa on GitHub - Source Code Repositories
  - - meta
    - property: og:description
      content: All eSpa project source code is open source on GitHub. Find firmware, hardware designs, and website source across our repositories.
---
...
### [wayne-love/ESPySpa](https://github.com/wayne-love/ESPySpa)
...
### [jbergler/esphome-spanet](https://github.com/jbergler/esphome-spanet)
...
All repositories welcome contributions! Whether it's fixing a bug, improving documentation, or adding a feature — check each repo's issues and pull requests to get involved. Join the [Discord](https://discord.gg/faK8Ag4wHn) to discuss ideas with the community.
