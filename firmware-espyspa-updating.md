...
::: warning
Always use the files that match your hardware version (v1.x or v2.x). If you are unsure which version you have, please see the [troubleshooting guide](https://espa.diy/troubleshooting).
:::
