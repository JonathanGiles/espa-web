...
eSpa is an open source community for spa home automation, built around [two firmware options](/firmware) and a simple [hardware design](/hardware) that you can build yourself, or [purchase pre-assembled](https://store.espa.diy).

## What is eSpa?

eSpa is a project to build a simple, open source, and affordable spa pool controller, and consists of both [firmware](/firmware) (with two options to choose from) and [hardware](/hardware). The project is built around the ESP32 microcontroller, and is designed to be easy to build and use. The project is open source, and is designed to be easy to modify and extend.
...
- [ESPySpa](https://github.com/wayne-love/ESPySpa) — the original Arduino/PlatformIO-based firmware
- [ESPHome SpaNet](https://github.com/jbergler/esphome-spanet) — an alternative ESPHome-based firmware
